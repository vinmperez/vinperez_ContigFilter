...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'vinperez_ContigFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from vinperez_ContigFilter.vinperez_ContigFilterImpl import vinperez_ContigFilter
impl_vinperez_ContigFilter = vinperez_ContigFilter(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['vinperez_ContigFilter.filter_contigs_async'] = ['vinperez_ContigFilter', 'filter_contigs']
async_check_methods['vinperez_ContigFilter.filter_contigs_check'] = ['vinperez_ContigFilter', 'filter_contigs']
sync_methods['vinperez_ContigFilter.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'vinperez_ContigFilter'
        ...
        self.rpc_service.add(impl_vinperez_ContigFilter.filter_contigs,
                             name='vinperez_ContigFilter.filter_contigs',
                             types=[dict])
        self.method_authentication['vinperez_ContigFilter.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "vinperez_ContigFilter but no authentication header was passed"
                            raise err
